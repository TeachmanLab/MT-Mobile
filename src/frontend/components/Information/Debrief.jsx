...
const Debrief = (props) => (
  <View style={{ flex: 1, backgroundColor: '#E5E7ED' }}>
    <Header
      ...
      rightComponent={
        <Icon onPress={() => props.navigation.toggleDrawer()} size={40} name="navicon" type="evilicon" color="white" />
      }
    />
    <ScrollView style={styles.scrollContainer} contentContainerStyle={{ flexGrow: 1 }}>
      <Card title={<AppText style={styles.title}>Thank You for Participating</AppText>} borderRadius={5}>
