  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#E5E7ED' }}>
      ...
      <ScrollView style={styles.scrollContainer}>
        <Card title={<AppText style={styles.title}>Thank You for Completing Our Assessment</AppText>} borderRadius={5}>
        ...
        <Card title={<AppText style={styles.title}>Please Note</AppText>} borderRadius={5}>
          <Divider style={{ marginBottom: '3%' }} />
          <AppText style={styles.body}>
